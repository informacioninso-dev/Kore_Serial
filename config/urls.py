...
urlpatterns = [
    ...
    path("almacen/", include(("wms.urls", "wms"), namespace="wms")),
    path("conectividad/", include(("edge.urls", "edge"), namespace="edge")),
    path("eventos/", include(("eventbus.urls", "eventbus"), namespace="eventbus")),
    path("integraciones/", include(("connect.urls", "connect"), namespace="connect")),
    ...
    path("api/wms/v1/", include(("wms.api_urls", "wms_api_v1"), namespace="wms_api_v1")),
    path("api/edge/v1/", include(("edge.api_urls", "edge_api_v1"), namespace="edge_api_v1")),
    path("api/connect/v1/", include(("connect.api_urls", "connect_api_v1"), namespace="connect_api_v1")),
